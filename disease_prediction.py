...
Original file is located at
    https://colab.research.google.com/drive/1ufydiWZIuMdCdJ8Wq9sYnxm2DLdv1rFA
"""
...
class DiseasePrediction:
    ...
    def train_model(self):
        ...
        # Training the Model
        classifier = DecisionTreeClassifier(criterion=self.config['model']['decision_tree']['criterion'])
